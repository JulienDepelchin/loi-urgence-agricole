...
meta = {
    ...
    "avertissements": [
        "Les 6e et 10e circonscriptions du Nord sont absentes du fichier RNE fourni (elus-deputes-dep.csv) — siège vacant ou export incomplet, à vérifier avant publication.",
        "La 17e circonscription du Nord liste deux titulaires dans le RNE (Thierry Tesson, mandat depuis le 2024-07-08, puis Vincent Ledoux, mandat depuis le 2025-01-24). Le titulaire retenu est celui dont le mandat a débuté le plus récemment (Vincent Ledoux).",
