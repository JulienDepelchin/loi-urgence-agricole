...
SENAT_SIGLES = {
    ...
    "Socialiste, Écologiste et Républicain": "SOC",
    "Les Indépendants - République et Territoires": "RTLI",
...
meta = {
    ...
    "avertissements": [
        ...
        "Les 51 fiches officielles (nom, département, circonscription, groupe) ont été revérifiées individuellement après les deux corrections ci-dessus. Aucun autre écart de rattachement n'a été trouvé. Deux sigles de groupes du Sénat avaient toutefois été mal déduits (le Sénat utilise lui-même SOC — pas SER — pour le groupe « Socialiste, Écologiste et Républicain », et RTLI — pas LIRT — pour « Les Indépendants - République et Territoires », d'après les URLs et intitulés de senat.fr) ; corrigés pour Patrick Kanner, Audrey Linkenheld, Marie-Claude Lermytte et Dany Wattebled.",
